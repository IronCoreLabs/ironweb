 ...
 */
export const createUser = (jwtToken: string, passcode: string, needsRotaion: boolean): Future<SDKError, CreateUserResponse> =>
    InitializationApi.createUser(passcode, jwtToken, needsRotaion).map((_) => ({
