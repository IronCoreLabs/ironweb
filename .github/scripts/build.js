...
shell.exec("./node_modules/typescript/bin/tsc --target ES6 --sourceMap false --module ES6 --outDir ./dist/shim/es && yarn run cleanTest");
shell.exec("./node_modules/typescript/bin/tsc --target ES6 --sourceMap false --module CommonJS --outDir ./dist/shim/commonjs && yarn run cleanTest");
...
//Copy the version and Readme into the shim package and derive its dependencies from what the built shim requires
shimPackage.dependencies = shimDependencies("./dist/shim/commonjs/shim/index.js", mainPackage.dependencies);
