...
function getFrameDomain(){
    switch(process.env.HOSTED_ENV){
        case 'prod': return 'https://api.ironcorelabs.com'
        case 'stage': return 'https://api-staging.ironcorelabs.com';
        case 'dev': return 'https://api-dev1.ironcorelabs.com';
        default: return 'https://dev1.ironcorelabs.com:4501';
    }
}
...
function serveJWT(req, res){
    res.json(jwt.sign({pid: projectIDs.projectId, sid: projectIDs.segmentId, kid: projectIDs.serviceKeyId || undefined}, privateKey, {
        algorithm: 'ES256',
        expiresIn: '2m',
